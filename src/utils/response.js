...
const StatusCodes = {
  ...
  ERROR_FORBIDDEN_ROLE: -5,
  ERROR_EXPIRED_ACCESS_TOKEN: -6,
  ERROR_REVOKED_ACCESS_TOKEN: -7,
  ERROR_INVALID_TOKEN: -8,
  ERROR_ACCESS_TOKEN: -9,
  ERROR_REFRESH_TOKEN: -10,
  ERROR_INVALID_USER: -11,
  ERROR_INVALID_ROLE: -12,
  ERROR_EXCEPTION: -13,
  ERROR_REVOKED_REFRESH_TOKEN: -14,
  ERROR_ALREADY_TAKEN: -15,
  ERROR_EMAIL_PASSWORD: -16,
};
